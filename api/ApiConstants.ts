...
export const CHILD_LOCATION_HISTORICAL =
  "/api/child/{child_id}/location/historical";
...
export const PARENT_LINK_CHILD_BY_QR =
  "/api/parent/link_child/{hashed_parent_id}"; // Get hashed link for generating QR code
